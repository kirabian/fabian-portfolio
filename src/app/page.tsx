...
export default function Home() {
  ...
  return (
    <main className="bg-[#18181b] text-[#e4e4e7] min-h-screen selection:bg-zinc-700 selection:text-white pb-32">
      
      {/* Navigation (Very Minimal, like a blog header) */}
      <nav className="max-w-3xl mx-auto px-6 pt-12 pb-16 flex justify-between items-center">
      ...
      <section className="max-w-3xl mx-auto px-6 mb-24">
        ...
        <div className="mt-12 inline-flex items-center gap-3 px-4 py-2 bg-zinc-800/50 rounded-md font-mono text-xs text-zinc-400 border border-zinc-700/50">
      ...
      <section className="max-w-4xl mx-auto px-6 mb-32">
        ...
        <div className="space-y-24">
          {[
            ...
            <div key={idx} className="flex flex-col md:flex-row gap-8 md:gap-12 items-start group">
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center">
                <h3 className="text-3xl font-bold mb-4 text-zinc-100" style={{ fontFamily: "'Playfair Display', serif" }}>
                  {proj.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {proj.tags.map(tag => (
                    <span key={tag} className="text-xs font-mono px-2 py-1 bg-zinc-800 text-zinc-400 rounded">
                      {tag}
                    </span>
                  ))}
                </div>
                <a href="#" className="inline-flex items-center gap-2 text-sm font-mono text-zinc-300 hover:text-white transition-colors w-max">
      ...
      <section className="max-w-3xl mx-auto px-6 mb-32">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 font-mono text-sm text-zinc-500">
          <ul className="space-y-2">
            <li className="hover:text-zinc-300 transition-colors">Laravel</li>
            <li className="hover:text-zinc-300 transition-colors">Next.js</li>
            <li className="hover:text-zinc-300 transition-colors">React</li>
          </ul>
          <ul className="space-y-2">
            <li className="hover:text-zinc-300 transition-colors">Flutter</li>
            <li className="hover:text-zinc-300 transition-colors">PHP</li>
            <li className="hover:text-zinc-300 transition-colors">Dart</li>
          </ul>
          <ul className="space-y-2">
            <li className="hover:text-zinc-300 transition-colors">MySQL</li>
            <li className="hover:text-zinc-300 transition-colors">PostgreSQL</li>
            <li className="hover:text-zinc-300 transition-colors">Redis</li>
          </ul>
          <ul className="space-y-2">
            <li className="hover:text-zinc-300 transition-colors">Git</li>
            <li className="hover:text-zinc-300 transition-colors">Docker</li>
            <li className="hover:text-zinc-300 transition-colors">Linux</li>
          </ul>
        </div>
      </section>

      {/* Footer / Connect */}
      <section className="max-w-3xl mx-auto px-6 border-t border-zinc-800 pt-16">
        ...
        <div className="flex flex-col sm:flex-row gap-6 mb-16">
          <a href="mailto:contact@fabian.com" className="inline-flex items-center justify-center gap-2 bg-zinc-100 text-zinc-900 px-6 py-3 rounded hover:bg-zinc-300 transition-colors font-medium">
            <Mail className="w-4 h-4" /> Email Me
          </a>
          <a href="https://github.com/kirabian" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 bg-zinc-800 text-zinc-100 px-6 py-3 rounded hover:bg-zinc-700 transition-colors font-medium border border-zinc-700">
        ...
        <div className="bg-zinc-900/50 p-6 rounded-lg border border-zinc-800/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a href="/resume.pdf" download className="inline-flex items-center gap-2 text-sm font-mono text-zinc-300 hover:text-white transition-colors underline decoration-zinc-600 underline-offset-4">
            <Download className="w-4 h-4" /> {t.resumeBtn}
          </a>
        </div>
      </section>
